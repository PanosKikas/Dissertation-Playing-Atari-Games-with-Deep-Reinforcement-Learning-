...
class DQNAgent:
    ...
    def save_weights(self):
        print("PRINT")
        self.model.save_weights("MsPacmanDQNWeights.h5")

    def save_model(self):
        self.model.save("DqnMsPacmanModel.h5")

    def restore_weights(self):
        print("Restoring model weights Pong")
        self.model.load_weights("MsPacmanDQNWeights.h5")


stats = Stats()
_env = gym.make('MsPacmanNoFrameskip-v4')
