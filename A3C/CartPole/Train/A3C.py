...
class A3CAgent(object):
    def __init__(self):
        ...
        self.starter_lr = 2.5e-4 # start value of learning rate
        ...
        self.global_network(tf.convert_to_tensor(np.random.random((1, 4)), dtype=tf.float32))
    ...
    def save_weights(self):
        ...
        self.global_network.save_weights("A3CCartpole.h5")

    def restore_weights(self):
        print("Restoring Weights!")
        self.global_network.load_weights("A3CCartpole.h5")
